package lt.bit.oop.day6.comparators;

import java.util.Arrays;
import java.util.Collections;
import java.util.Comparator;
import java.util.List;
import lt.bit.oop.day6.comparators.PlayerComparators.PlayerComparatorByScoreDesc;
...
class PlayerMain {
  ...
  public static void main(String[] args) {
    ...
    PlayerComparators.PlayerComparatorByScoreDesc pComp1 = comparators.new PlayerComparatorByScoreDesc();
    PlayerComparators.PlayerComparatorByScoreDesc pComp2 = new PlayerComparators().new PlayerComparatorByScoreDesc();
